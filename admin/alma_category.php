<?
// *******************************************************************
// ALMA管理画面カテゴリー編集 PHP Encording UTF-8
// *******************************************************************
...
"WHERE ctgr_id = ?";
		...
		header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
		 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/alma_category.php" );
		exit;
...
$catg_tbl .= "<form method=\"get\" action=\"alma_category.php\">\n";
