<?PHP
// *******************************************************************
// ALMA管理画面お知らせ編集　PHP　Encording UTF-8
// *******************************************************************
...
"WHERE info_id = ?";
		...
		header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
		 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/alma_info.php?status=" . $show );
		exit;
...
")";
			...
			header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
			 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/alma_info.php?status=0" );
			exit;
...
$tpcs_tbl .= "<form method=\"get\" action=\"alma_info.php\">\n";
...
// ***********************************************************************
	...
	$action = "alma_info.php?status=" . $show;
