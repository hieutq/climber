<?
// *******************************************************************
// ALMAトップバナー編集　PHP　Encording UTF-8
// *******************************************************************
...
"WHERE img_id = ?";
		...
		header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
			 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/alma_top_image.php" );
		exit;
...
"WHERE img_id = ?";
		...
		$dfile = "../alma/images/top/top_image_" . $id . ".jpg";
...
$img_tbl .= "<form method=\"get\" action=\"alma_top_image.php\">\n";
$img_tbl .= "<input type=\"hidden\" name=\"id\" value=\"" . $img_id . "\" />\n";
$img_tbl .= "<tr>\n";
$img_tbl .= "<td class=\"alignR\">" . $img_id . "</td>\n";
$img_tbl .= "<td><a href=\"../alma/images/top/top_image_" . $img_id . ".jpg\" onclick=\"return hs.expand(this)\" class=\"highslide\">";
