<?
// *******************************************************************
// ENGLISH管理画面カテゴリー編集 PHP Encording UTF-8
// *******************************************************************
...
"WHERE ctgr_id = ?";
		...
		header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
		 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/eng_category.php" );
		exit;
...
")";
	...
	$sql  =
'SELECT '
	.'ctgr_id,ctgr_menu,ctgr_order,ctgr_name,status'.
' FROM '
	.'eng_category'.
' WHERE '
	.'status <= ?'.
...
$catg_tbl .= "<form method=\"get\" action=\"eng_category.php\">\n";
