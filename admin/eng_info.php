...
"WHERE info_id = ?";
		...
		header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
		 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/eng_info.php?status=" . $show );
		exit;
...
")";
			...
			header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
			 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/eng_info.php?status=0" );
			exit;
...
$tpcs_tbl .= "<form method=\"get\" action=\"eng_info.php\">\n";
...
// ***********************************************************************
	...
	$action = "eng_info.php?status=" . $show;
