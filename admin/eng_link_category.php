<?
// *******************************************************************
// ENGLISH管理画面リンクカテゴリー編集 PHP Encording UTF-8
// *******************************************************************
...
"WHERE lctgr_id = ?";
			...
			header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
			 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/eng_link_category.php" );
			exit;
...
"WHERE sctgr_id = ? ";
			...
			header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
			 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/eng_link_category.php?sub=" . $sub );
			exit;
...
$catg_tbl .= "<form method=\"get\" action=\"eng_link_category.php\">\n";
...
$catg_tbl .= "</form>\n";
	...
	if(!$sub){
		$action = "eng_link_category.php";
	}else{
		$action = "eng_link_category.php?sub=" . $sub;
	}
