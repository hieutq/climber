...
"WHERE news_id = ?";
		...
		header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
		 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/eng_news.php?status=" . $show );
		exit;
...
")";
			...
			header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
			 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/eng_news.php?status=0" );
			exit;
...
$news_tbl .= "<form method=\"get\" action=\"eng_news.php\">\n";
...
// ***********************************************************************
	...
	$action = "eng_news.php?status=" . $show;
