<?
// *******************************************************************
// ICP管理画面記事リスト　PHP　Encording UTF-8
// *******************************************************************
	...
	if(!$catg){
		...
		header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
		 . dirname( $_SERVER[ "PHP_SELF" ] ) . "/icp_content_list.php?catg=1" );
		exit;
	...
	if( $_GET[ "modify" ] != NULL ){
		...
		header( "Location: http://" . $_SERVER[ "HTTP_HOST" ] . ""
		 . dirname( $_SERVER[ "PHP_SELF" ] ) .
			"/icp_content_modify.php?catg=" . $catg . "&id=" . $cid );
		exit;
...
$cts_tbl .= "<form method=\"get\" action=\"icp_content_list.php\">\n";
