<?php
// *******************************************************************
// 英語版ページ登録　PHP　Encording UTF-8
// *******************************************************************

	session_start();
	include_once( "./../../include/az_constant.php" );
	include_once( "./../../include/eng_admin.php" );
	include_once( "./../../admin/eng_contents_regist.php" );
...
<h2>ファイルアップロード</h2>
<script src="js/fileuploader_eng.js?cid=<?=$id?>" type="text/javascript" id="plusId"></script>
...
<script>
	function createUploader(){
		var uploader = new qq.FileUploader({
			...
			action: 'script/upload_eng.php?id=<?=$id?>',
			debug: true
		});
	}
