<?php
// *******************************************************************
// 英語版新着情報　PHP　Encording UTF-8
// *******************************************************************

	session_start();
	include_once( "./../../include/az_constant.php" );
	include_once( "./../../include/eng_admin.php" );
	include_once( "./../../admin/eng_info.php" );
...
<option value='eng_info.php?status=0'>表示中のアイテムのみ</option>
<option value='eng_info.php?status=1'<?=$status_op?>>全表示</option>
</select>
</div>
</form>
