<?php
// *******************************************************************
// ICP新着情報　PHP　Encording UTF-8
// *******************************************************************

	session_start();
	include_once( "./../../include/az_constant.php" );
	include_once( "./../../include/icp_admin.php" );
	include_once( "./../../admin/icp_info.php" );
...
<option value='icp_info.php?status=0'>表示中のアイテムのみ</option>
<option value='icp_info.php?status=1'<?=$status_op?>>全表示</option>
</select>
</div>
</form>
