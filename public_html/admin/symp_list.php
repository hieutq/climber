<?php
// *******************************************************************
// シンポジウム・セミナー申込一覧　PHP　Encording UTF-8
// *******************************************************************
	...
	include_once( "./../../admin/symp_list.php" );
...
<body>
<div id="admin_cts">
<div id="title">シンポジウム・セミナー 一覧</div>

<div id="list">
<?=$page_link1?> <?=$page_link2?>

<form method="POST" action="">
<input type="submit" name="REGIST" value=" シンポジウム・セミナー追加 ">
</form>

<table class="ubar">
	<tr>
		<th width="50" style="text-align: center;">ID</th>
		<th width="250" style="text-align: center;">処理</th>
		<th width="80" style="text-align: center;">表示</th>
		<th width="180" style="text-align: center;">開催日</th>
		<th width="300" style="text-align: center;">シンポジウム・セミナー名</th>
	</tr>
