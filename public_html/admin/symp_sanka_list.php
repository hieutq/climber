<?php
// *******************************************************************
// シンポジウム参加申込一覧　PHP　Encording UTF-8
// *******************************************************************
	...
	include_once( "./../../admin/symp_sanka_list.php" );
...
<body>
<div id="admin_cts">
<div id="title"><?=$symp_name?> 参加者一覧</div>
...
<form method="POST" action="">
<input type="submit" name="BACK" value=" &laquo; シンポジウム一覧に戻る ">&nbsp;
