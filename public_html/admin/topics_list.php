...
// *******************************************************************
	...
	include_once( "./../../admin/topics_list.php" );
...
<? } ?>
表示文章：<input type="text" name="regist_tpc_body" value="" size="80"><br />
登録日：
<select name="regist_tpc_datey">
<?
