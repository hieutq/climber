...
//***********************************************************************
	...
	include_once( "./../../src/part_conv_sanka_entry.php" );
...
$member_kubun_radio_nologin = html_radios(
	$op_arr = $member_kubun01_nologin,
	$selected = $dsp[ 'member_kubun01' ],
	$op_name = 'kubun',
	$separator='&nbsp;',
	$col=''
...
<form method="POST" action="?mode=content&pid=34" onSubmit="return check()">
<h2>参加申込</h2>
<div class="main_box">
<h3>大会参加申込</h3>
...
<input class="submit_button" name="CONV_SANKA_SEND" type="submit" value="　送　信　" />　<input class="reset_button"  name="RESET" type="submit" value="　リセット　" />
...
<form name="test" method="POST" action="?mode=content&pid=34" onSubmit="return check()">
<h2>参加申込</h2>
<div class="main_box">
<h3>大会参加申込</h3>
<p style="color: #F00;font-weight: bold;">$err_msg</p>
...
<td>{$member_kubun_radio_nologin}<br />※会員の方はログインして申し込んでください<br />※協賛学協会会員の方は、備考欄に所属先の学協会名をご記入ください</td>
</tr>
<!--<tr>
...
<tr>
<th><span class="fc_red">※</span>勤務先/学校 住所<br />
...
<tr>
<th> 備考 </th>
<td>※協賛学協会会員の方は、備考欄に所属先の学協会名をご記入ください<br><textarea name="bikou" cols="70" rows="8" id="bikou">{$dsp[ 'sanka_biko1']}</textarea></td>
</tr>
<!--
<tr>
<th>紹介者名</th>
...
<div class="alignC">
内容を充分にご確認の上、送信して下さい。<br />
<input class="submit_button" name="CONV_SANKA_SEND" type="submit" value="　送　信　" />　<input name="RESET" type="submit" value="　リセット　" class="reset_button" />
<input type="hidden" name="convention_id" value="{$dsp[ 'convention_id']}" />
</div>
</div>
</form>
