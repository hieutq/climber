...
//***********************************************************************
	...
	include_once( "./../../src/part_conv_sanka_entry_test.php" );
...
<form method="POST" action="?mode=test" onSubmit="return check()">
<h2>参加申込</h2>
<div class="main_box">
<h3>大会参加申込</h3>
...
<td>{$member_kubun_radio_nologin}<br />※会員の方はログインして申し込んでください</td>
</tr>
<!--<tr>
